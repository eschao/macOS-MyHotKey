...
- (void)fetchActions {
    ...
    AXUIElementCopyActionNames((__bridge AXUIElementRef)self.element,
                               &actions);
...
- (id)getValueOfAttrName:(NSString *)name {
    ...
    if (AXUIElementCopyAttributeValue((__bridge AXUIElementRef)self.element,
...
- (NSArray *)getArrayValueOfAttrName:(NSString *)name {
    ...
    if (AXUIElementGetAttributeValueCount((__bridge AXUIElementRef)self.element,
        ...
        if (AXUIElementCopyAttributeValues((__bridge AXUIElementRef)self.element,
                                          (__bridge CFStringRef)name,
                                          0,
                                          count,
...
- (BOOL)isAttributeSettable:(NSString *)name {
    ...
    AXUIElementIsAttributeSettable((__bridge AXUIElementRef)self.element,
                                   (__bridge CFStringRef)name,
                                   &isSettable);
...
- (BOOL)setBoolValueForAttrName:(NSString *)name
                          value:(BOOL)value {
    return (AXUIElementSetAttributeValue((__bridge AXUIElementRef)self.element,
                                    (__bridge CFStringRef)name,
